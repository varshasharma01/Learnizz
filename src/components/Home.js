  ...
  return (
    <div className="Home">
      <animated.div style={title}>
        ...
        <h1 className="maintitle-mobile">Welcome to Learnizz</h1>
      </animated.div>
      <animated.div style={text}>
        <div className="intro-text">
          <p id="intro">
            Learnizz is a quiz game full of surprises! <br></br>
            Try to answer each question while the clock is running. If you get
            stuck, use the card. <br></br>
        ...
        <div className="intro-text-mobile">
          <ReadMore>
            <Typography className="intro-mobile">
              Learnizz is a quiz full of surprises!<br></br>
              Try to answer each question while the clock is running. If you get
              stuck, use the card. <br></br>To enter the game, click the
              spinning wheel.
            </Typography>
          </ReadMore>
        </div>
